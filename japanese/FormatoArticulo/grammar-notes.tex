...
\begin{document}
	...
	% \pagebreak Descomentar si se desea un salto de pagina entre
	% indice y contenido
	...
	% funcionaran.
	\section{\protect\tjp{始めましょう！}}
	\subsection{Ejemplo sección}
	\subsubsection{Ejemplo subsección}
